...
public class ExtractDiscoverMovies extends AsyncTask<String, Void, String> {
    ...
    public ExtractDiscoverMovies(Context context, List<Movie> movieList, RecyclerView recyclerView) {
    ...
    private void PutDataIntoRecyclerView(List<Movie> movieList){
        DiscoverMovieAdapter adapter = new DiscoverMovieAdapter(context, movieList);
